...
readData=500000
m=70
path="/home/abhay/Desktop/project101/delhi.csv"
supp=8
k=3
minconf=10
maxSupp=100
...
# with open("./procCorona/stemdict.txt", "rb") as fp:
#     lemma=pickle.load(fp)
# def matched(word):
#     ans=[i for i in lemma if i.find(word)!=-1]
#     return ans
# len(remove_punctuation(matched("_")))
...
#     with open("./procData/trans.txt", "wb") as fp:  #<---------------------ADDRESS
#         pickle.dump(transactions, fp)

#     with open("./procData/item_trans.txt", "wb") as fp:  #<---------------------ADDRESS
#         pickle.dump(item_trans, fp)
        
#     with open("./procData/itemDict.txt", "wb") as fp:    #<---------------------ADDRESS
#         pickle.dump(revDict, fp)
        
#     with open("./procData/items.txt", "wb") as fp:         #<---------------------ADDRESS
...
# path="/home/abhay/Desktop/project101/NSFabsDataset/*/*/*/*.txt"  #<---------------------ADDRESS
# m=50
start=time.time()
func(m,path)
end=time.time()
